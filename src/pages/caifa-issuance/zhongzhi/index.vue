...
import { getZhongZhiList, deleteZhongZhiItem } from './api';
...
export default {
    ...
    methods: {
        ...
        async handeleQuery(params) {
            ...
            const list = await getZhongZhiList(Object.assign({actionIds: 'zhong_zhi'}, query, params));
            this.listData = {
                list: list.content,
