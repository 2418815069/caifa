...
import {bianGeng, getCaiFaXianEList } from './api';
...
export default {
    ...
    methods: {
        ...
        async huiShouClick() {
            ...
            let v = await bianGeng(Object.assign(query, {wenHao: this.wenHao}, {guid: this.guid}));
            if (v.code === 200) {
                this.$message({
                    type: 'success',
                    message: v.message
...
<template>
    <div>
        ...
        <div class="title-bck2">{{nianFen}}年单位已分配限额</div>
