...
function getBianGengHtml(jixuValue, chuCaiValue, jixuProp, chuCaiProp, isNeedJiXu) {
    if (isNeedJiXu) {
    ...
    <div style="height:50px;border-bottom:1px solid #EBEEF5">
        ...
        <div style="height:50px;border-bottom:1px solid #EBEEF5">
        <div style="border-bottom:1px solid #EBEEF5;color:red">${chuCaiValue}</div><div><input prop=${chuCaiProp} value=${chuCaiValue} style="width:80%"></input></div>
        </div>
        </div>`;
    }
...
export const bianGenglistPropsConfig = [
    ...
    },
    {
        label: '分类',
        returnHtml: function () {
            return '<div style="height:50px;"><div style="height:50px">积蓄</div></div>';
        }
    },
    {
        label: '生态公益林',
        ...
        option: [
            ...
            },
            {
                label: '更新采伐',
                returnHtml: function (row) {
                    return getBianGengHtml(row.sgylGxcf, row.sgylGxcfCc, 'gylGxcf', 'gylGxcfCc');
                }
            },
            {
                label: '低产林改造',
    ...
    },
    {
        ...
        option: [
            ...
            },
            {
                label: '主伐',
                returnHtml: function (row) {
                    return getBianGengHtml(row.ssplZf, row.ssplZfCc, 'splZf', 'splZfCc');
                }
            },
            {
                label: '抚育采伐',
