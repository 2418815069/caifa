...
export default {
    data() {
        return {
            ...
            queryParams: {
                zhongZhiTime: [], caiFaLeiXingFangShi: [], shiXiangMcZl: []
            },
            listData: {
                list: [],
                total: 0
    ...
    // 操作区回调
        ...
        async handleOk() {
            ...
            let arr = ['danWei', 'isXiane', 'linQuanDm', 'qiYuanDm', 'systemType', 'qianFaRen', 'caiFaZh', 'projid', 'shenQinRen', 'caiFaLxdm', 'caiFaFsdm', 'timberType', 'shiXiangJbm', 'yinShuaHq', 'yinShuaHz', 'qianFaSjq', 'qianFaSjz'];
            arr.map((x, index)=>{
                if (query[arr[index]]) {
