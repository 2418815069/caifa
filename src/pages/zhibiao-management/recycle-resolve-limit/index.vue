...
<template>
    <div>
        ...
        <div class="title-bck2">{{nianFen}}年编限单位已分配指标</div>
        ...
        />
        <div class="title-bck2">第三部  收回指标</div>
