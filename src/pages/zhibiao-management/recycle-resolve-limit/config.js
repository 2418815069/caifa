...
export const listPropsConfig = [
    ...
    },
    {
        ...
        {
            label: '抚育采伐',
            option: [{label: '总量', prop: 'zsplFyf'}, {label: '剩余', prop: 'sgylFycf'}]
        },
        {
            label: '低产林改造',
            option: [{label: '总量', prop: 'zsplDg'}, {label: '剩余', prop: 'sgylDgcf'}]
        },
        {
            label: '其他采伐',
            option: [{label: '总量', prop: 'zsplQtcf'}, {label: '剩余', prop: 'sgylQtcf'}]
        }
        ]
    },
    {
