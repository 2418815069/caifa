...
<template>
  <div>
    <div class="group-title">第一步  选择指标</div>
    <xcy-form
      ref="xcyForm"
    ...
    <div class="group-title">第二部  分解指标</div>
    <div class="zhui-jia-input">
        ...
        <el-table :data="tableData" style="width: 100%">
          <el-table-column align="center" label="分类">
            <template slot-scope="scope">
              <div v-if="scope.$index===0" style="color:red">可用指标</div>
              <div v-if="scope.$index===1">分解指标</div>
            </template>
          </el-table-column>
      ...
      <div style="text-align:center;margin:20px 0">
        <el-button type="primary" size="mini" @click="addXianE">预存指标</el-button>
      </div>

      <div class="group-title">{{this.formDataStep1.nianFen}}年归口单位预存指标</div>
